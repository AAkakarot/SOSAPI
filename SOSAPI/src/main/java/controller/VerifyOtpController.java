...
public class VerifyOtpController  {
    ...
    private static MyLogManager myLogManager =new MyLogManager(VerifyOtpController.class);
    ...
    @ResponseBody
    public void verifyOtp(@RequestParam String phonenumber,@RequestParam String otp, HttpServletRequest httpServletRequest,HttpServletResponse httpServletResponse) throws Exception {
        myLogManager.info("inside verify otp");
        JSONObject response=verifyOtpService.verifyOtp(phonenumber,otp);
